                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="drpcate" runat="server" CssClass="txt" 
                                ...
                                <asp:ListItem>Couple watch</asp:ListItem>
                                <asp:ListItem>Pink girls watch</asp:ListItem>
                                <asp:ListItem>Silver watch</asp:ListItem>
                                <asp:ListItem>Smart watch</asp:ListItem>
                                <asp:ListItem>Couple silver watch</asp:ListItem>
                                <asp:ListItem>Smart watch black</asp:ListItem>
                                <asp:ListItem>Gold watch</asp:ListItem>
                                <asp:ListItem>Girls leather watch</asp:ListItem>
